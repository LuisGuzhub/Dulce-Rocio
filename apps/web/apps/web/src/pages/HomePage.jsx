...
`
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
              ...
              >
                <h1
                  className="heading-serif text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 text-balance leading-tight drop-shadow-[0_4px_15px_rgba(0,0,0,0.6)]"
                  style={{ letterSpacing: '-0.02em' }}
                >
                  Postres personalizados hechos con amor
                </h1>

                <p
                  className="heading-serif text-xl md:text-2xl lg:text-3xl font-normal text-white mb-8 max-w-2xl mx-auto leading-[1.4] text-balance drop-shadow-[0_4px_15px_rgba(0,0,0,0.6)]"
          ...
          <section className="py-24 bg-gradient-to-b from-[#fff8f3] via-[#fffdfb] to-[#fff6f1] overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <span className="inline-block text-sm md:text-base font-semibold tracking-[0.22em] uppercase text-[#cb7f5d] mb-4">
                  Dulce Rocío
                </span>
