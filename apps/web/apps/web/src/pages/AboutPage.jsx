    ...
    <>
      ...
      <div className="min-h-screen flex flex-col bg-[#f8f3ef]">
        ...
        <main className="flex-1">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="lg:pr-4">
                  ...
                  <button className="inline-flex items-center gap-3 rounded-full bg-[#d78963] hover:bg-[#c97752] text-white px-7 py-4 text-base shadow-md hover:shadow-lg transition-all duration-300">
          ...
          <section className="pb-20 md:pb-24 bg-[#f8f3ef]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <motion.div
                initial={{ opacity: 0, y: 24 }}
